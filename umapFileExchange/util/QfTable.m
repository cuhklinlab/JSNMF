    ...
    methods
        function this=QfTable(qf, tClrs, props, priorFig, visible)
            ...
            ToolBarMethods.addButton(tb_, fullfile(path, 'histQF.png'), ...
                'See similarity histogram based on QFMatch', ...
                @(h,e)doHistQF(this));            
    ...
    methods(Static)
        ...
        function [data, names, widths, tips, unmatched, plotIdx, freqIdx,...
            ...
            names={'#', ...
                ...
                Html.WrapSm('Mass+distance<br>similaritry'), ...
            ...
            tips={...
                ...
                'Higher percentages indicate more overlap of cells (or bins)',...
